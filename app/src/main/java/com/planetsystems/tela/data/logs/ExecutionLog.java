...
public class ExecutionLog {
    ...
    public ExecutionLog(String message, String date, String time, String className, String deviceNo, String school, String data, String lineNumber, String methodName) {
