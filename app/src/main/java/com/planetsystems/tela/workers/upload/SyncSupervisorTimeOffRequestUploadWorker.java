...
public class SyncSupervisorTimeOffRequestUploadWorker extends Worker {
    SyncEmployeeTimeOffRequestDMDao syncEmployeeTimeOffRequestDMDao;
    public SyncSupervisorTimeOffRequestUploadWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        List<SyncEmployeeTimeOffRequestDM> syncEmployeeTimeOffRequestDMS = syncEmployeeTimeOffRequestDMDao.getSupervisorRequestRecords(false);
        for(SyncEmployeeTimeOffRequestDM syncEmployeeTimeOffRequestDM: syncEmployeeTimeOffRequestDMS) {
            ...
            try {
                ...
                if (resp == Urls.DID_WORK) {
                    syncEmployeeTimeOffRequestDM.setUploadedSupervisor(true);
